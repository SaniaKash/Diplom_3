...
class TestPersonalAccount:
    ...
    def test_open_personal_account_through_personal_acc_butt_success(self, driver):
    ...
    def test_open_page_order_history_from_personal_account(self, driver):
        user = MainPage(driver)
        user.wait_for_main_page_located()
        user.click_personal_account_button()
        user = EnterPage(driver)
    ...
    def test_click_exit_button_personal_account_open_login_page_success(self, driver):
        user = MainPage(driver)
        user.wait_for_main_page_located()
        user.click_personal_account_button()
        user = EnterPage(driver)
